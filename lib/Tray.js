...
function setupTray() {
    ...
    contextMenu = Menu.buildFromTemplate([
        {checked: true, label: 'Settings', icon: getIcon('wrench'), submenu: [
            {
                checked: Lib.UserSettings.getSetting(Lib.UserSettings.constants.CHECK_SONGS_ON_SAVE), 
                type: 'checkbox', label: 'Check if song is already saved', 
                sublabel: "Much faster without, but will move already saved songs to the top of your list",
                click: updateSetting.bind(null, Lib.UserSettings.constants.CHECK_SONGS_ON_SAVE)
            },
            {
                checked: Lib.UserSettings.getSetting(Lib.UserSettings.constants.NOTIFICATION_SOUND_ON), 
                type: 'checkbox', label: "Notifications have sound",
                click: updateSetting.bind(null, Lib.UserSettings.constants.NOTIFICATION_SOUND_ON)
            }
        ]},
        {type: 'separator'},
...
function updateSetting(setting, menuItem) {
    Lib.UserSettings.setSetting(setting, menuItem.checked);
}
